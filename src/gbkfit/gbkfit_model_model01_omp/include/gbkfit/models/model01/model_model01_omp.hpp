...
private:
    ...
    NDArrayHost* m_data_flxcube_up;
    NDArrayHost* m_data_flxcube_up_fft;

    NDArrayHost* m_data_psfcube;
    NDArrayHost* m_data_psfcube_u;
    NDArrayHost* m_data_psfcube_up;
    NDArrayHost* m_data_psfcube_up_fft;

    NDArrayHost* m_data_flxcube;
    NDArrayHost* m_data_flxmap;
    NDArrayHost* m_data_velmap;
    NDArrayHost* m_data_sigmap;
