...
GModel1Cuda::GModel1Cuda(FlxProfileType flx_profile,
                           VelProfileType vel_profile)
    : GModel1(flx_profile, vel_profile)
{
}

const std::string& GModel1Cuda::get_type(void) const
{
    return GModel1CudaFactory::FACTORY_TYPE;
}

void GModel1Cuda::evaluate(const std::vector<float>& params_prj,
