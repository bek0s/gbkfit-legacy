...
GModel01::GModel01(FlxProfileType flx_profile, VelProfileType vel_profile)
...
const std::vector<std::string>& GModel01::get_param_names(void) const
{
    return m_param_names;
}

void GModel01::evaluate(const std::map<std::string, float>& params,
